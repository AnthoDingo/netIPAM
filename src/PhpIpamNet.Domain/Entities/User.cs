...
/// In PhpIpamNet new users get a BCrypt hash. To keep compatibility with imported phpIPAM
/// databases, see <see cref="PhpIpamNet.Infrastructure.Identity.LegacyCryptVerifier"/>.
/// </summary>
[Table("users")]
public class User
{
