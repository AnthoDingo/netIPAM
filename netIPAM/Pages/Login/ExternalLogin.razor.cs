...
namespace netIPAM.Pages.Login
{
    public partial class ExternalLogin
    {
        ...
        [Inject]
        protected ILogger<ExternalLogin> Logger { get; set; } = default!;
        ...
        private async Task OnValidSubmitAsync()
        {
            if (externalLoginInfo is null)
            {
                RedirectManager.RedirectToWithStatus("login", "Error loading external login information during confirmation.", HttpContext);
                return;
            }
